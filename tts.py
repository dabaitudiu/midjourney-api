...
class TextToSpeech(object):
    ...
    def save_audio(self, data, child_path, voices):
        ...
        for j in range(len(voices)):
            ...
            if response.status_code == 200:
                with open(child_path + voices[j] + '.mp3', 'wb') as audio:
...
if __name__ == "__main__":
    ...
    #     # 遍历列表中的每个元素，并将其写入文件
    #     file.write(text)
    app.save_audio("这，就是我最后的战争，无穷无尽。。。你们真的天真的以为谈判就能带来和平？不要搞笑了好吗？？ 杀尽一切！！士兵们，跟着我，冲锋！！！","voices/", short_names)
